...
<c:forEach items="${viewProduct}" var="a" varStatus="status" >
	<form action="templatePage.jsp" method="post">
			...
			<table width="100%">
			<tr><td align="center"><img class="product_image" src="imageViewer.jsp?imgID=${a.id}" height=400px width=300px/></td>	
			...
			<div class="list-group" height="100%">
				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
  				...
  				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    				...
    				<option>L</option>
   	 				...
   	 				<tr><td>
      					...
      					<p class="mb-1"><input name="getQuantity" type="number" class="selectpicker" min="1" required/></p>
   	 				</td></tr>
   	 				</table>
  				...
  				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    				...
    				<input type="hidden" name="price" value="${a.price}" ></input>
  				...
  				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    				<div class="d-flex w-100 justify-content-between">
      					<h5 class="mb-1" style="font-weight: bold;">
      						...
      						<input type="submit" value="Design Product" class="btn btn-success"/>
